...
export default function Layout({children, language}: LayoutProps) {
    ...
    return (
        <>
            ...
            <Header language={language} open={open} setOpen={setOpen}></Header>
            <Navigation language={language} open={open} setOpen={setOpen}></Navigation>

            <div className="nav-overlay d-xl-none" onClick={() => setOpen(!open)}></div>
