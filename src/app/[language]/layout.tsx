...
export const metadata: Metadata = {
    ...
    // 'Marco Starker - Senior Fullstack Developer mit Expertise in Webanwendungen, PHP, JavaScript, NodeJS, Docker und AWS. Verfügbar für Freelancer-Projekte und langfristige Kooperationen. Kontaktieren Sie mich für innovative Softwarelösungen und individuelle Beratung.'
    authors:   {name: 'Marco Starker'},
    creator:   'Marco Starker',
    publisher: 'Marco Starker',
    icons:     {
...
type LayoutProps = {
    params: MS.PageParameter;
    children: React.ReactNode;
};
export default function RootLayout({params, children}: LayoutProps) {
    return (
        <html lang={params.language} className={poppins.variable}>
