...
<section id="top" class="hero">
    <div class="row gx-4 align-items-center">
        <div class="col-12 col-md-6 col-xl-7 hero-content">
            <div>
                <h4 class="text-uppercase freelancer">HI, I'M A FREELANCER</h4>
                <h1 class="text-uppercase overflow-hidden developer" id="typewriter" data-typewriter="Developer, Architect, Fullstack Dev, Problem Solver"></h1>
        ...
        <div class="col-12 col-md-5 offset-md-1 offset-xxl-1 col-xl-4">
